...
const App = () => {
  ...
  return (
    <div className="text-white bg-black w-full h-screen p-3 ">
      <div className="flex flex-row flex-wrap justify-center overflow-scroll lg:overflow-hidden gap-1 w-full h-[calc(100%-12%)] ">
        {loading &&
          Array.from({ length: minLength }).map((_, idx) => {
            return (
              <div
                key={idx}
                className="bg-gray-700 p-3 rounded-xl animate-pulse w-96 h-56 lg:w-56 lg:h-48"
              >
          ...
          return (
            ...
            >
              <a href={elem.url} target="_blank">
                <div className=" overflow-hidden bg-gray-300 rounded-2xl w-96 h-48 lg:w-56 lg:h-48">
                  <img
                    loading="lazy"
